...
function createMarkers(info, http){
	...
	marker.addListener("click", function(){
		...
		document.getElementById('modal-image-body').innerHTML = "<div><img data-toggle='modal' src='"+item["url"]+"></div>";
		...
		data.forEach(function(item, index){
			...
			"<div class='container-fluid map-infowindow'>"
				+ "<div class='row'>"
					...
					+ "<div class='col-md-6'>"
						+ "<img data-toggle='modal' data-target='#myModal' src='"+item["url"]+"' class='map-infowindow-img' onclick='show_img('"+item["url"]+"')'>"
					+ "</div>"
