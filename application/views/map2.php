							...
							<div ng-repeat='feedback in feedbacks' ng-show='feedbacks.length'>
								...
								<div class="feedback-message " ng-mouseover="recordActivity('Feedback mouse over', feedback['feedback_id']+ ' '+feedback['message']); mouseoverFeedback(feedback)" ng-mouseleave="mouseleaveFeedback()">
									...
									<div class="row">
										...
										<div class='col-md-4 '>
											<img class='feedback-message-social social-network-icon' src="/assets/img/socialnetworks/twitter_light.png" alt="Twitter" height="18" width="18">
											<img class='feedback-message-social social-network-icon' src="/assets/img/socialnetworks/facebook_light.png" alt="Twitter" height="18" width="18">
											<img class='feedback-message-social social-network-icon' src="/assets/img/socialnetworks/google_light.png" alt="Twitter" height="18" width="18">
										...
										<div class="col-md-6 feedback-message-buttons">
											...
											<a class='feedback-message-button-reply' href='' ng-click="replyFeedback(feedback.feedback_id)">Reply</a>
										</div>
