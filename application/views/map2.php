								...
								<div class="feedback-message " ng-mouseover="recordActivity('Feedback mouse over', feedback['feedback_id']+ ' '+feedback['message']); mouseoverFeedback(feedback)" ng-mouseleave="mouseleaveFeedback()">
									...
									<div class="row">
										...
										<div class='col-md-4 feedback-message-social'>
											<img class='' src="/assets/img/socialnetworks/twitter_light.png" alt="Twitter" height="18" width="18">
											<img class='' src="/assets/img/socialnetworks/facebook_light.png" alt="Twitter" height="18" width="18">
											<img class='' src="/assets/img/socialnetworks/google_light.png" alt="Twitter" height="18" width="18">
