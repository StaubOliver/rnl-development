					...
					<div class='feedback-section'>
						...
						<div class="row">
							...
							<div ng-repeat='feedback in feedbacks' ng-show='feedbacks.length'>
								...
								<div class="feedback-message " ng-mouseover="recordActivity('Feedback mouse over', feedback['feedback_id']+ ' '+feedback['message']); mouseoverFeedback(feedback)" ng-mouseleave="mouseleaveFeedback()" ng-click="clickFeedbakc(feedback['feedback_id']">
