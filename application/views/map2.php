								...
								<div class="row feedback-form">
									...
									<div class="col-md-12">
										...
										<div ng-repeat='marker in selected_markers'>
											<div class='btn btn-custom-default btn-xs' ng-click="remove_marker(marker, $index)" ng-mouseover="highlight_marker(marker)" ng-mouseleave="remove_highlight(marker)"> <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>{{ marker['title'].split("-")[1]}}
											</div>
										</div>
									</div>
					...
					<div class='feedback-section'>
						...
						<div class="row">
							...
							<div ng-repeat='feedback in feedbacks' ng-show='feedbacks.length'>
								<div class="feedback-message feedback-message-clicked" ng-mouseover="recordActivity('Feedback mouse over '+feedback['feedback_id']+ ' '+feedback['message']); mouseoverFeedback(feedback)" ng-mouseleave="mouseleaveFeedback()">
									<div class="row">
