	...
	<div class="row main-layout">
		...
		<div class="col-md-9 main-layout-left">
			...
			<div class='controller-googleMap' ng-controller='GoogleMap'>
				...
				<div class="modal-lg-image fade" id="Modal-large-image" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal-lg-image" aria-label="Close"><span aria-hidden="true">&times;</span></button>
