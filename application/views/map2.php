...
<body ng-controller="GoogleMap">
	...
	<div class="map-legend">
		<div class='row'>
			<div class='col-md-12'>
				<h4 class='map-legend-title' ><span class="glyphicon glyphicon-chevron-down map-legend-title-glyph" aria-hidden="true" ng-click="show_legend=!show_legend"></span>  Legend</h4>
			</div>
		</div>
