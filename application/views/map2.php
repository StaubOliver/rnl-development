								...
								<div class="row feedback-form">
									...
									<div class="col-md-12">
										...
										<div ng-repeat='marker in selected_markers'>
											<div class='btn btn-custom-default btn-xs' ng-click="remove_marker(marker, $index)" ng-mouseover="highlight_marker(marker)" ng-mouseleave="remove_highlight(marker)"> <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>{{ marker['title']}}
											</div>
										</div>
									</div>
