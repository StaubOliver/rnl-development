						...
						-->
							...
							<div class='col-md-12 admin-message-head'>
								<div class='row'>
									...
									<div class='col-md-2'>
										<div class='col-md-12 admin-btn' ng-show="!show_map[feedback.feedback_id]">
									...
									<div class='col-md-2'>
										...
										<div class='col-md-12 admin-btn' ng-show="feedback.hidden == 0">
										...
										<div class='col-md-12 admin-btn' ng-show="feedback.hidden == 1">
