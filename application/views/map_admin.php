			...
			<div class='row'>
				...
				<div ng-repeat='feedback in feedbacks' ng-show='feedbacks.length'>
					...
					<div ng-repeat='rep in feedback.replies' ng-show='feedback.replies.length'>
						...
						<div class='col-md-10 col-md-offset-1' ng-class="{'admin-feedback-reply':rep.hidden==0, 'admin-feedback-reply-hidden':rep.hidden==1, 
						'admin-feedback-reply-hidden':feedback.hidden==1}">
