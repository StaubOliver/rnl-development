				...
				<div class='col-md-10 col-md-offset-1 admin-title' ng-show="selectedUniqueId == 0">
					<div class='row'>
						...
						<div style="display:block; text-align:right" class='col-md-6'>
							<button style='margin-top:5px' type="button" class="btn btn-xs btn-custom-default" ng-click="show_dwell_fct_actions_data = !show_dwell_fct_actions_data">Show Data</button>
